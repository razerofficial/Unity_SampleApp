...
namespace ChromaSDK
{
    public class ChromaAnimationAPI
    {
		...
		public static int GetAnimation(string animation)
		{
            ...
            {
                Debug.LogError(string.Format("GetAnimation: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
            /*
            if (animationId == -1)
        ...
        public static void PlayAnimationName(string animation)
		{
            ...
            {
                Debug.LogError(string.Format("PlayAnimationName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
		}
        ...
        public static void StopAnimationName(string animation)
		{
            ...
            {
                Debug.LogError(string.Format("StopAnimationName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
		}
		...
		public static void OffsetNonZeroColorsAllFramesName(string animation, int red, int green, int blue)
        {
            ...
            {
                Debug.LogError(string.Format("OffsetNonZeroColorsAllFramesName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
		...
		public static void MultiplyIntensityAllFramesName(string animation, float intensity)
        {
            ...
            {
                Debug.LogError(string.Format("MultiplyIntensityAllFramesName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
		...
		public static void MultiplyIntensityAllFramesRGBName(string animation, int red, int green, int blue)
        {
            ...
            {
                Debug.LogError(string.Format("MultiplyIntensityAllFramesRGBName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        /// <summary>
        /// Fill the rgb via min and max thresholds for all frames
        /// </summary>
        /// <param name="animation"></param>
        /// <param name="minThreshold"></param>
        /// <param name="minRed"></param>
        /// <param name="minGreen"></param>
        /// <param name="minBlue"></param>
        /// <param name="maxThreshold"></param>
        /// <param name="maxRed"></param>
        /// <param name="maxGreen"></param>
        /// <param name="maxBlue"></param>
		public static void FillThresholdColorsMinMaxAllFramesRGBName(string animation, int minThreshold, int minRed, int minGreen, int minBlue, int maxThreshold, int maxRed, int maxGreen, int maxBlue)
        {
#if UNITY_EDITOR_WIN || UNITY_STANDALONE_WIN
            string path = GetStreamingPath(animation);
            IntPtr lpData = GetIntPtr(path);
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginFillThresholdColorsMinMaxAllFramesRGBName(lpData, minThreshold, minRed, minGreen, minBlue, maxThreshold, maxRed, maxGreen, maxBlue);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("FillThresholdColorsMinMaxAllFramesRGBName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        /// <summary>
        /// Make blank frames initialized to rgb color
        /// </summary>
        /// <param name="animation"></param>
        ...
        /// <param name="green"></param>
        /// <param name="blue"></param>
        public static void MakeBlankFramesRGBName(string animation, int frameCount, float duration, int red, int green, int blue)
        {
#if UNITY_EDITOR_WIN || UNITY_STANDALONE_WIN
            string path = GetStreamingPath(animation);
            IntPtr lpData = GetIntPtr(path);
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginMakeBlankFramesRGBName(lpData, frameCount, duration, red, green, blue);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("MakeBlankFramesRGBName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void FadeStartFramesName(string animation, int fade)
        {
            ...
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginFadeStartFramesName(lpData, fade);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("FadeStartFramesName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void FadeEndFramesName(string animation, int fade)
        {
            ...
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginFadeEndFramesName(lpData, fade);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("FadeEndFramesName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void MultiplyIntensityName(string animation, int frameId, float intensity)
        {
            ...
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginMultiplyIntensityName(lpData, frameId, intensity);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("MultiplyIntensityName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void MultiplyIntensityColorName(string animation, int frameId, int color)
        {
            ...
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginMultiplyIntensityColorName(lpData, frameId, color);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("MultiplyIntensityColorName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }

        public static void FillThresholdColorsRGBName(string animation, int frameId, int threshold, int red, int green, int blue)
        {
#if UNITY_EDITOR_WIN || UNITY_STANDALONE_WIN
            string path = GetStreamingPath(animation);
            IntPtr lpData = GetIntPtr(path);
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginFillThresholdColorsRGBName(lpData, frameId, threshold, red, green, blue);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("FillThresholdColorsRGBName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }

        public static void FillThresholdColorsAllFramesRGBName(string animation, int threshold, int red, int green, int blue)
        {
#if UNITY_EDITOR_WIN || UNITY_STANDALONE_WIN
            string path = GetStreamingPath(animation);
            IntPtr lpData = GetIntPtr(path);
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginFillThresholdColorsAllFramesRGBName(lpData, threshold, red, green, blue);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("FillThresholdColorsAllFramesRGBName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void OverrideFrameDurationName(string animation, float duration)
        {
            ...
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginOverrideFrameDurationName(lpData, duration);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("OverrideFrameDurationName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void InvertColorsAllFramesName(string animation)
        {
            ...
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginInvertColorsAllFramesName(lpData);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("InvertColorsAllFramesName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void ReduceFramesName(string animation, int n)
        {
            ...
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginReduceFramesName(lpData, n);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("ReduceFramesName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void DuplicateFramesName(string animation)
        {
            ...
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginDuplicateFramesName(lpData);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("DuplicateFramesName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }

        public static void MakeBlankFramesName(string animation, int frameCount, float duration, int color)
        {
#if UNITY_EDITOR_WIN || UNITY_STANDALONE_WIN
            string path = GetStreamingPath(animation);
            IntPtr lpData = GetIntPtr(path);
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginMakeBlankFramesName(lpData, frameCount, duration, color);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("MakeBlankFramesName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void TrimStartFramesName(string animation, int numberOfFrames)
        {
            ...
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginTrimStartFramesName(lpData, numberOfFrames);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("TrimStartFramesName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void TrimEndFramesName(string animation, int numberOfFrames)
        {
            ...
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginTrimEndFramesName(lpData, numberOfFrames);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("TrimEndFramesName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void DuplicateFirstFrameName(string animation, int frameCount)
        {
            ...
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginDuplicateFirstFrameName(lpData, frameCount);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("DuplicateFirstFrameName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }

        public static void FillZeroColorAllFramesRGBName(string animation, int red, int green, int blue)
        {
#if UNITY_EDITOR_WIN || UNITY_STANDALONE_WIN
            string path = GetStreamingPath(animation);
            IntPtr lpData = GetIntPtr(path);
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginFillZeroColorAllFramesRGBName(lpData, red, green, blue);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("FillZeroColorAllFramesRGBName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void ReverseAllFramesName(string animation)
        {
            ...
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginReverseAllFramesName(lpData);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("ReverseAllFramesName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void DuplicateMirrorFramesName(string animation)
        {
            ...
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginDuplicateMirrorFramesName(lpData);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("DuplicateMirrorFramesName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void FillRandomColorsBlackAndWhiteAllFramesName(string animation)
        {
            ...
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginFillRandomColorsBlackAndWhiteAllFramesName(lpData);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("FillRandomColorsBlackAndWhiteAllFramesName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }

        public static void MultiplyIntensityRGBName(string animation, int frameId, int red, int green, int blue)
        {
#if UNITY_EDITOR_WIN || UNITY_STANDALONE_WIN
            string path = GetStreamingPath(animation);
            IntPtr lpData = GetIntPtr(path);
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginMultiplyIntensityRGBName(lpData, frameId, red, green, blue);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("MultiplyIntensityRGBName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void FillThresholdColorsAllFramesName(string animation, int threshold, int color)
        {
            ...
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginFillThresholdColorsAllFramesName(lpData, threshold, color);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("FillThresholdColorsAllFramesName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void InsertDelayName(string animation, int frameId, int delay)
        {
            ...
            try
            {
                if (lpData != IntPtr.Zero)
                {
                    PluginInsertDelayName(lpData, frameId, delay);
                }
            }
            catch (Exception ex)
            {
                Debug.LogError(string.Format("InsertDelayName: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
#endif
        }
        ...
        public static void AddNonZeroAllKeysAllFramesName(string sourceAnimation, string targetAnimation)
        {
            ...
            {
                Debug.LogError(string.Format("AddNonZeroAllKeysAllFramesName: Add frames animation: {0} exception={1}", sourceAnimation, ex));
            }
        ...
        public static void CopyNonZeroTargetAllKeysAllFramesName(string sourceAnimation, string targetAnimation)
        {
            ...
            {
                Debug.LogError(string.Format("CopyNonZeroTargetAllKeysAllFramesName: Animation: {0} exception={1}", sourceAnimation, ex));
            }
            FreeIntPtr(lpSourceData);
            FreeIntPtr(lpTargetData);
#endif
        ...
        private static int OpenAnimation(string animation)
        {
            ...
            {
                Debug.LogError(string.Format("OpenAnimation: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
            return animationId;
        }
        ...
        public static int PluginSaveAnimation(int animationId, string animation)
        {
            ...
            {
                Debug.LogError(string.Format("PluginSaveAnimation: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
            return result;
        }
        ...
        public static int CreateAnimation(string animation, Device device)
        {
            ...
            {
                Debug.LogError(string.Format("CreateAnimation: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
            return result;
        }
        ...
        public static void PauseAnimationName(string animation)
        {
            ...
            {
                Debug.LogError(string.Format("PauseAnimationName: Animation: {0} exception={1}", path, ex));
            }
            FreeIntPtr(lpData);
        }
        ...
        public static void ResumeAnimationName(string animation, bool loop)
        {
            ...
            {
                Debug.LogError(string.Format("ResumeAnimationName: Animation: {0} exception={1}", path, ex));
            }
            FreeIntPtr(lpData);
        }
        ...
        public static void CloseAnimationName(string animation)
        {
            ...
            {
                Debug.LogError(string.Format("CloseAnimationName: Animation: {0} exception={1}", path, ex));
            }
            FreeIntPtr(lpData);
        }
        ...
        public static int EditAnimation(string animation)
        {
            ...
            {
                Debug.LogError(string.Format("EditAnimation: Animation: {0} exception={1}", animation, ex));
            }
            FreeIntPtr(lpData);
            return animationId;
        }
